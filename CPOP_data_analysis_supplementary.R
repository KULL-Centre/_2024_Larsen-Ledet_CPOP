...
ggroc(list(esm1b1b_30 = roc(del_thres$cutoff_30, del_thres$esm1b_score),
      ...
      legacy.axes = TRUE, linewidth = 2, aes = c("color", "linetype")) +
  labs(x = "False Positive Rate", y = "True Positive Rate") +
  scale_linetype_manual("", labels = c(bquote(esm1b1b: "30 °C " (AUC == .(round(auc(del_thres$cutoff_30, del_thres$esm1b_score), 2)))),
                                       bquote(esm1b1b: "30 °C + MTX" (AUC == .(round(auc(del_thres$cutoff_30_MTX, del_thres$esm1b_score), 2)))),
                                       bquote(esm1b1b: "37 °C " (AUC == .(round(auc(del_thres$cutoff_37, del_thres$esm1b_score), 2)))),
                                       bquote(esm1b1b: "37 °C + MTX" (AUC == .(round(auc(del_thres$cutoff_37_MTX, del_thres$esm1b_score), 2))))),
                        values = c(1, 1, 1, 1)) +
  scale_color_manual("", labels = c(c(bquote(esm1b1b: "30 °C " (AUC == .(round(auc(del_thres$cutoff_30, del_thres$esm1b_score), 2)))),
                                      bquote(esm1b1b: "30 °C + MTX" (AUC == .(round(auc(del_thres$cutoff_30_MTX, del_thres$esm1b_score), 2)))),
                                      bquote(esm1b1b: "37 °C " (AUC == .(round(auc(del_thres$cutoff_37, del_thres$esm1b_score), 2)))),
                                      bquote(esm1b1b: "37 °C + MTX" (AUC == .(round(auc(del_thres$cutoff_37_MTX, del_thres$esm1b_score), 2)))))),
                     values = c("orange", "limegreen", "magenta3", "dodgerblue2")) +
